...
module.exports.resetPwdWithLongToken = function (options, resetToken, password) {
  var passwordField = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'password';
...
module.exports.resetPwdWithShortToken = function (options, resetShortToken, identifyUser, password) {
  var passwordField = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'password';
...
function resetPassword(options, query, tokens, password, passwordFieldName) {
  ...
  var passwordField = passwordFieldName || 'password';
  ...
  return Promise.all([userPromise, hashPassword(options.app, password)]).then(function (_ref) {
    ...
    return patchUser(user, (_patchUser = {}, _defineProperty(_patchUser, passwordField, hashedPassword), _defineProperty(_patchUser, 'resetToken', null), _defineProperty(_patchUser, 'resetShortToken', null), _defineProperty(_patchUser, 'resetExpires', null), _patchUser)).then(function (user1) {
      return notifier(options.notifier, 'resetPwd', user1, { passwordField: passwordField });
    }).then(function (user1) {
