  ...
  options.app.use(options.path, {
    create: function create(data) {
      ...
      switch (data.action) {
        ...
        case 'resetPwdShort':
          return resetPwdWithShortToken(options, data.value.token, data.value.user, data.value.password, data.value.passwordField);
        case 'passwordChange':
          return passwordChange(options, data.value.user, data.value.oldPassword, data.value.password, data.value.passwordField);
        case 'identityChange':
          return identityChange(options, data.value.user, data.value.password, data.value.changes, data.value.passwordField);
        case 'options':
