...
module.exports = function sendResetPwd(options, identifyUser, notifierOptions, passwordFieldName) {
  ...
  var notifierOpts = Object.assign({}, notifierOptions, { passwordField: passwordField });
  ...
  return Promise.resolve().then(function () {
    ...
    return notifier(options.notifier, 'sendResetPwd', user, notifierOpts).then(function () {
      return user;
    });
  }).then(function (user) {
