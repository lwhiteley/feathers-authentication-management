...
function AuthManagement(app) {
  ...
  this.sendResetPwd = function (identifyUser, notifierOptions, passwordField) {
    return authManagement.create({
      action: 'sendResetPwd',
      value: identifyUser,
  ...
  this.resetPwdLong = function (resetToken, password, passwordField) {
    return authManagement.create({
      action: 'resetPwdLong',
      value: { token: resetToken, password: password, passwordField: passwordField }
    }, {});
  };

  this.resetPwdShort = function (resetShortToken, identifyUser, password, passwordField) {
    return authManagement.create({
      action: 'resetPwdShort',
      value: { user: identifyUser, token: resetShortToken, password: password, passwordField: passwordField }
    }, {});
  };

  this.passwordChange = function (oldPassword, password, identifyUser, passwordField) {
    return authManagement.create({
      action: 'passwordChange',
      value: { user: identifyUser, oldPassword: oldPassword, password: password, passwordField: passwordField }
    }, {});
  };

  this.identityChange = function (password, changesIdentifyUser, identifyUser, passwordField) {
    return authManagement.create({
      action: 'identityChange',
      value: { user: identifyUser, password: password, changes: changesIdentifyUser, passwordField: passwordField }
    }, {});
  };
