...
module.exports = function identityChange(options, identifyUser, password, changesIdentifyUser, passwordFieldName) {
  ...
  return Promise.resolve().then(function () {
    ...
    return Promise.all([user1, getLongToken(options.longTokenLen), getShortToken(options.shortTokenLen, options.shortTokenDigits), comparePasswords(password, user1[passwordField], function () {
